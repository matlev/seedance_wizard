...
public sealed class Gate0DurableArtifactRetentionTests
{
    ...
    public void DurableManifestPinsPrivateContentAddressedR2WithoutCredentials()
    {
        ...
        Assert.Equal(3026, source.GetProperty("logicalArtifactCount").GetInt32());
        Assert.Equal(536_266_536, source.GetProperty("logicalArtifactBytes").GetInt64());
    ...
    public void OfflineManifestValidationNeedsNeitherCredentialsNorNetwork()
    {
        ...
        Assert.Equal(3026, document.RootElement.GetProperty("requiredLogicalArtifactCount").GetInt32());
    ...
    public void OfflineValidationRejectsFalseCompletionAndSchemaExpansion(string mutation)
    {
        ...
        try
        {
            ...
            if (mutation == "false-completion")
            {
                ...
                status["verifiedLogicalArtifactCount"] = 3026;
                status["verifiedLogicalArtifactBytes"] = 536_266_536;
                status["blocker"] = null;
            }
            else
            {
