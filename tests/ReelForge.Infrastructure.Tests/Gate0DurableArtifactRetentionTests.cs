...
public sealed class Gate0DurableArtifactRetentionTests
{
    ...
    public void DurableManifestPinsPrivateContentAddressedR2WithoutCredentials()
    {
        ...
        Assert.Equal(3913, source.GetProperty("logicalArtifactCount").GetInt32());
        Assert.Equal(951_081_202, source.GetProperty("logicalArtifactBytes").GetInt64());
    ...
    public void OfflineManifestValidationNeedsNeitherCredentialsNorNetwork()
    {
        ...
        Assert.Equal(3913, document.RootElement.GetProperty("requiredLogicalArtifactCount").GetInt32());
    ...
    public void OfflineValidationRejectsFalseCompletionAndSchemaExpansion(string mutation)
    {
        ...
        try
        {
            ...
            if (mutation == "false-completion")
            {
                ...
                status["verifiedLogicalArtifactCount"] = 3913;
                status["verifiedLogicalArtifactBytes"] = 951_081_202;
                status["blocker"] = null;
            }
            else
            {
