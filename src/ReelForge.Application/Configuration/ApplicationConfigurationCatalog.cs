...
public static class ApplicationConfigurationCatalog
{
    ...
    [
        ...
        new("MediaTools.LogFfmpegCommands", "Log generated FFmpeg command", "Warning: this should only be enabled for debugging purposes", false, false,
        ...
        new("MediaTools.LogFfprobeCommands", "Log generated ffprobe command", "Warning: this should only be enabled for debugging purposes", false, false,
            "false", MediaToolsSection),
