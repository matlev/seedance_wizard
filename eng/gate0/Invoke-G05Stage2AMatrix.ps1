...
if ([string]$authorization.status -ne 'owner-authorized-and-prerequisites-verified') { throw 'Stage 2A execution remains fail-closed until the semantic cell executor and retention integration receive an effective authorization binding.' }
