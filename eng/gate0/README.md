...
The canonical current state and active authorization are maintained in `docs/gate-0-current-status.md`. Historical decision/result documents retain the status that was true when their evidence was recorded. Future measured-evidence growth is governed by `docs/gate-0-evidence-containment.md`. The exact Stage 2A run completed all 18 cells and retained 108 authoritative attempt records: 36 passed, two semantically divergent, and 70 blocked after fail-fast route suspension. Six baseline/typical 720p cells passed; the two stress 720p warm-ups reached the same structured-audio quality gate; remaining stress and all 1080p cells were blocked without media. Independent retrieval verified all 289 indexed local/R2 artifacts. No further media is effective pending the Stage 2A owner packet.
